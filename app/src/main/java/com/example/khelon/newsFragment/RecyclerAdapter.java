...
public class RecyclerAdapter extends RecyclerView.Adapter<MyViewHolder>{
    ...
    public RecyclerAdapter(Context context, List<NewsDataClass> dataList) {
...
class MyViewHolder extends RecyclerView.ViewHolder{
    ...
    public MyViewHolder(@NonNull View itemView) {
        ...
        teamImage = itemView.findViewById(R.id.newsCardImage);
        teamHeading = itemView.findViewById(R.id.newsCardHeading);
        teamDesc = itemView.findViewById(R.id.newsCardDescription);

        recCard = itemView.findViewById(R.id.newsCard);
    }
}